...
default_entity_map = Dict{Char,Union{Type,Function}}(
    ...
    '<' => SpikesLeft,
    'v' => SpikesDown,
    '>' => SpikesRight, 'P' => Player, 'D' => DreamBlock,
    'C' => CrumbleBlock, '_' => JumpThru, 'O' => GreenBooster,
    'Q' => RedBooster, 'W' => Water, 'S' => Spinner, 'B' => Bumper, 'R' => Refill,
    'F' => Feather, 'H' => CrystalHeart
)
...
entity_offsets = Dict{Union{Type,Function},Tuple{Integer,Integer}}(
    ...
    SpikesLeft => (8, 0),
    SpikesDown => (0, 0),
    SpikesRight => (0, 0), Player => (8, 8), DreamBlock => (0, 0),
    CrumbleBlock => (0, 0), JumpThru => (0, 0), GreenBooster => (4, 4),
    RedBooster => (4, 4), Refill => (4, 4),
    Feather => (4, 4), Water => (0, 0), Spinner => (4, 4), Bumper => (4, 4), Spring => (8, 8),
    SpringLeft => (0, 8),
    SpringRight => (8, 8),
    CrystalHeart => (0, 0)
)
...
search_for_size = Dict{Union{Type,Function},Tuple{Bool,Bool}}(
    ...
    SpikesRight => (false, true), DreamBlock => (true, true),
    CrumbleBlock => (true, false),
    DashBlock => (true, true),
    NegaBlock => (true, true), JumpThru => (true, false), Barrier => (true, true), Water => (true, true), Spinner => (false, false), Refill => (false, false),
    Feather => (false, false), GreenBooster => (false, false),
    RedBooster => (false, false), Spring => (false, false),
    SpringLeft => (false, false),
    SpringRight => (false, false), Bumper => (false, false), CrystalHeart => (false, false)
)
